...
`;console.info("%c BERM-THERMAL-FLOW-CARD %c 0.1.0 ","color: white; font-weight: bold; background: #039be5","color: #039be5; font-weight: bold; background: white");let ee=class extends nt{static getConfigElement(){}static getStubConfig(){return{type:`custom:${pt}`,entities:{outside:{temperature:"sensor.outdoor_temperature"},fans:[],rooms:[]}}}static get styles(){return te}setConfig(t){try{this._config=function(t){if(!t)throw new Error(Dt);if(!t.entities)throw new Error(Dt);if(!t.entities.outside||!t.entities.outside.temperature)throw new Error(Bt);const e=Array.isArray(t.entities.fans)?t.entities.fans:[],i=Array.isArray(t.entities.rooms)?t.entities.rooms:[],o=e.map((t,e)=>{if(!t.name)throw new Error(`Fan at index ${e} is missing 'name'`);if(!t.speed)throw new Error(`Fan '${t.name}' is missing 'speed' entity`);return{...t,power_map:t.power_map||ut}});return i.forEach((t,e)=>{if(!t.name)throw new Error(`Room at index ${e} is missing 'name'`);if(!t.temperature)throw new Error(`Room '${t.name}' is missing 'temperature' entity`);if(void 0!==t.fan_index&&null!==t.fan_index&&(t.fan_index<0||t.fan_index>=o.length))throw new Error(`Room '${t.name}' has invalid fan_index ${t.fan_index}. Must be between 0 and ${o.length-1}`)}),{type:"custom:berm-thermal-flow-card",entities:{outside:t.entities.outside,fans:o,rooms:i,greenhouse:t.entities.greenhouse},colors:Qt(ft,t.colors||{}),temperature_thresholds:Qt(mt,t.temperature_thresholds||{}),animation:Qt($t,t.animation||{}),display:Qt(_t,t.display||{})}}(t),this._error=void 0}catch(t){this._error=t instanceof Error?t.message:"Unknown error",console.error("Berm Thermal Flow Card configuration error:",t)}}getCardSize(){return 12}shouldUpdate(t){return!(!this._config||!this.hass)}_computeCardState(){const{entities:t,colors:e,temperature_thresholds:i}=this._config,o=qt(this.hass,t.outside.temperature,70),s={temperature:o,rate:t.outside.rate?qt(this.hass,t.outside.rate,0):void 0,color:It(o,i,e)},r=t.fans.map(t=>{const e=Math.round(qt(this.hass,t.speed,0)),i=function(t,e=ut){const i=Math.round(t).toString();return e[i]??ut[i]??0}(e,t.power_map||ut);return{name:t.name,speed:Math.max(0,Math.min(10,e)),power:i,offline:t.offline||!Gt(this.hass,t.speed),icon:t.icon||gt}}),n=t.rooms.map(t=>{const o=qt(this.hass,t.temperature,70),s=t.delta?qt(this.hass,t.delta,0):void 0,r=t.desired_temp?qt(this.hass,t.desired_temp,70):void 0;return{name:t.name,temperature:o,delta:s,desired_temp:r,fan_index:t.fan_index,color:It(o,i,e),icon:t.icon||yt}});let a;if(t.greenhouse?.enabled&&t.greenhouse.temperature){const o=qt(this.hass,t.greenhouse.temperature,70);a={temperature:o,delta:t.greenhouse.delta?qt(this.hass,t.greenhouse.delta,0):void 0,color:It(o,i,e)}}return{outside:s,fans:r,rooms:n,greenhouse:a}}_generateFlowLines(t){if(!this._config)return[];const e=[],{fans:i,rooms:o}=t,{animation:s}=this._config,r=Ct,n=Pt,a=St,c=xt/2;return i.forEach((o,n)=>{const l=this._getFanX(n,i.length),d=o.speed>0&&!o.offline;e.push({id:`outside-fan-${n}`,path:Zt(c,a+wt,l,r-bt),from:{x:c,y:a},to:{x:l,y:r},speed:o.speed,animationDuration:d?Xt(o.speed,s):0,color:t.outside.color,active:d})}),o.forEach((t,a)=>{if(void 0!==t.fan_index&&null!==t.fan_index&&t.fan_index>=0&&t.fan_index<i.length){const c=i[t.fan_index],l=this._getFanX(t.fan_index,i.length),d=this._getRoomX(a,o.length),h=c.speed>0&&!c.offline;e.push({id:`fan${t.fan_index}-room${a}`,path:Zt(l,r+bt,d,n-At),from:{x:l,y:r},to:{x:d,y:n},speed:c.speed,animationDuration:h?Xt(c.speed,s):0,color:t.color,active:h})}}),e}_getFanX(t,e){return Ot+(xt-2*Ot)/(e+1)*(t+1)}_getRoomX(t,e){return Ot+(xt-2*Ot)/(e+1)*(t+1)}render(){if(!this._config||!this.hass)return B``;if(this._error)return B`
        <ha-card>
          <div class="error">
    ...
    `}_renderGreenhouseNode(t){const{display:e}=this._config,i=xt/2,o=kt,s=Et;return B`
      <g class="node ${Ht}">
